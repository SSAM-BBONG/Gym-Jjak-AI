...
def no_candidates_found() -> AppError:
    return AppError(404, "PT_RECOMMENDATION_NO_CANDIDATES", "조건에 맞는 PT코스를 찾지 못했습니다.")
...
def spring_data_unavailable() -> AppError:
    return AppError(502, "PT_RECOMMENDATION_SPRING_UNAVAILABLE", "회원·PT코스 정보를 조회하지 못했습니다.", True)
